  ...
  return (
    <div className="min-h-screen bg-kivah-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-kivah-100 p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold text-kivah-700 mb-1">Create your account</h2>
        <p className="text-gray-400 text-sm mb-6">Start managing your whole life in one place</p>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link to="/login" className="text-kivah-600 font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </div>
